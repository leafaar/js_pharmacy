...
const cancelElement = document.querySelector('.btn.cancelar');
...
buyElement.onclick = () => {
    ...
    if(total == 0){
        sendData('error', {msg: 'Você não adicionou nada ao carrinho.'});
    }else{
        containerRight.style.display = 'none';
        containerLeft.style.display = 'none';
        loadingElement.style.display = 'initial';
        sendData('tryPayment', {total: getTotal(), itens: itens});
        setTimeout(() => {
...
box11.createBox();
const box12 = new Product('Xerelto', 50, 'pills');
box12.createBox();


const xerelto = new Product('nome', 125, 'xerelto');
xerelto.createBox();
